...
const enemigo = [ {
        ...
        descripcion_habilidades: ['Usa el puto flexbox de una fucking vez: Te pasas miles de horas alineando imágenes y para que, ¡USA EL FLEXBOX! Recibes daño igual a su fuerza.', '¿A eso lo llamas position: Relative?: Como vas a superponer una imagen si ni siquieras sabes que position es algo que puedes usar en CSS, el daño que recibe se divide en 2.'],
        },
    ...
    },
    {
        ...
        descripcion_habilidades: ['¿Quieres una kata, guapo?: Si a lo largo del bootcamp estábais cansados del lenguaje, imaginad lo que es una kata en semana de proyecto, te quita daño igual a su fuerza.', 'Map is not a function: Después de haber estado buscando porque coño no funcionan tus métodos de array te das cuenta de que no estás iterando sobre una array, pierdes 6 puntos de daño.'],
    ...
    },
    {
        ...
        descripcion_habilidades: ['¿Section?¿Id?¿Class? ¿Eso se come?: Parece que no te has dado cuenta de la sintaxis, poner div a todo no es una buena práctica, por eso te hace daño equivalente a su fuerza.', '¿Crees que así vas a subir de puesto en Google? Pardillo: Poner nombres de clase en cada idioma existente del mundo o tener que usar keywords como: class="menuda-SeCcIon-mçs_guapa" no es que sean muy válidas, por eso recibes 8 puntos de daño.'],
    ...
    },
    {
        ...
        descripcion_habilidades: ['No se te ve nada, ¿No te habrás olvidado de poner el layout?: Parece mentira que no hayas prestado atención a Dani, así que vengo yo a recordártelo, recibes daño igual a su fuerza.', 'Ah, que quieres hacer validaciones con DOM y tu usuario en base de datos, pues prepárate que vas a flipar: Has querido avanzar muy rápido sin siquiera pensar en hacer algo que dieron en clase mientras tu pensabas en como sobrevivir al bootcamp, pierdes 15 de daño porque ni Handlebars te va a librar.'],
        },
...
},
{
    ...
    descripcion_habilidades: ['req.params y res.send: Semana final de proyecto y ni siquiera has podido entender esta mierda, por lo que pierdes vida igual a su fuerza.', '¿Pensabas que enviar información se quedaba en la local storage? HAHAHA: Parece que te has confiado con lo que sabías del módulo 1 y ahora te viene todo grande: pierdes vida igual al doble de la fuerza del enemigo.'],
    },  
...
},
{
    ...
    descripcion_habilidades: ['El Mate Legendario: Leandro coge su mate y te da de probar, te envenena debido a que no tienes sangre del señor de los mates y pierdes 5 de vida durante 3 turnos.', 'Descanso de Bootcamp: Este señor casi acaba desquiciado debido al bootcamp como TA, por lo que restablece un tercio de su vida.', 'QUE ES ESE ERROR: Debido al estrés por ser TA, ve el código de sus alumnos y al no tener su mente estable, no puede más y se ríe haciendote daño igual a su fuerza.'],
    },
...
},
{
    ...
    descripcion_habilidades: ['Por el Poder de la Luna: Ha puesto tantas veces el fondo animado de Sailor Moon que ya se sabe los movimientos para invocar el poder de la luna, y en el nombre del amor te quita vida igual a su fuerza','Labia Intensa: Lo adoras y lo odias en sintonia, te confunde y al no poder dejar de escucharlo durante un turno no le haces daño', 'Ritmo Hipster: Se ha pillado unas gafas para poder trabajar pero ahora se tinta el pelo, la barba y usa las gafas como atuendo, debido a su Hipsterismo, te quita tu propio estilo y te roba vida igual a su habilidad, por lo que se cura la misma cantidad.'],
    },
...
},
{
    ...
    habilidades:{
        ...
        descripcion_habilidades: ['¿Componente? ¿Redirect? ¿Tags diferentes? Ese soy yo, ¡DIO! Digo, ¡REACT!: Después del módulo 2 con handlebars y node.js pensabas que se te iba a dar mejor el frontend, santo iluso, te hace daño igual a su fuerza.', 'Access to https:iron-league.com has been blocked by CORS policy: El talón de aquiles de los programadores frontend, recibes 20 de daño.'],   
    } ,
