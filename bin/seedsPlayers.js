...
const player = [{
    ...
    },
    {
        ...
        descripcion_habilidades: ['Dale al Play: Los verdaderos poderes de Sara solo se activan cuando escucha música, las vibraciones provocadas por su aura afectan al enemigo y le hace daño equivalente a su fuerza más un bonus de 1 a 5 puntos de daño.', 'Como me toques los cascos vas a flipar: El enemigo intenta quitarle los cascos a Sara y pero esta es más rápida y lo tira al suelo, el enemigo no hace nada en su siguiente turno.', 'La Música está en mis Venas: Sara sin música no puede vivir y todos los empleados de Ironhack lo sabemos. La defensa de Sara sube y recibe la mitad de daño del enemigo en sus 2 siguientes turnos.'],
        },
