...
const player = [{
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Kobold', 'Amor Paternal', 'Evolución Inquisitiva'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Diva', 'Abanico de Idiomas', 'Flash de la Fama'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Master of Games', 'Lenguaje Madrileño', 'Simpatía y amistad'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Tatuaje de Amor de Madre', '¡Kraken a la vista!', 'Aviso para Navegantes'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Perseverancia Antinatural', 'Parental Advisor', 'Programación anímica'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Gaming Abusivo', 'El Temblor del Pueblo', 'Perseverancia Maestra'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Testosterona', 'Grito de Derrumbe', 'Valor y Corazón'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Sujeta el Cubata', 'Golpe Bestial', 'Dame más whisky'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['¡METAAAAAAAL!', 'Rasgueo Escalofriante', 'Sacudida de Melena'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Espada de Luz', 'Excarmiento Santo', 'Sanctum Recitāre'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Matrix', 'Dominación Cibernética', 'Corazón de León'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Throw Rainbows Up', 'Por el poder del Arcoiris', 'Ilusión Multicolor'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Llave de Ira', 'Engaño Siniestro', 'Experiencia Mundana'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Renuncia a tus derechos', 'Este grupo no entra por mi coño', 'Como te explico que no hay dispo'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Futurología', 'Advertencia de Peligro', 'Buen Humor'],
    ...
    },
    {
        ...
        habilidades: {
        nombres: ['Tentación Mortal','Tentación Efímera', 'Oda a Melissa'],
        ...
        image_url: 'https://res.cloudinary.com/dg9s4kl26/image/upload/v1603138316/iron%20league/fotos%20alumnos%20cartas/Mar_jej527.jpg',
        motivación: 40,
    },
    {
        nombre: 'Sara',
